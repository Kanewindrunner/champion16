        ...
        public:
            ...
            bool GetPrediction(uint64_t pc){
                ...
                if(cell[127].Yout >= 0.5)
                    ...
                    predicte_result = 0;
		//cout<< predicte_result << endl;
                return predicte_result;
            }  
            
            void UpdatePredictor(bool ture_result,Optype optype,bool resolvedir,bool predDir,uint64_t branchTarget){
                float error[64];
                int para;
